<%@page import="com.jci.model.LedgerReportDTO"%>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Ledger Report List</h1>
            </div>
                 <% List<LedgerReportDTO> ledgerList = (List<LedgerReportDTO>) request.getAttribute("allLedgerReport"); 
                 String Crop_Year =  (String)request.getAttribute("crop_year");
                 String Farmer =  (String)request.getAttribute("customInput");
                 String Basis =  (String)request.getAttribute("basis"); 
                  %>
                 
                 
                                     <div class="page-content fade-in-up">
                                     <form action = "LedgerReportDownload.obj">
                                     
                                     <div class="row">
                                     
                                        <div class="col-sm-4 form-group">
										 <label class="required">Farmer</label> 
			                             <input class="form-control" type="text" name="farmer" placeholder="Farmer Address" value="<%=Farmer %>" readonly>
								          </div>
            ...
            <div class="ibox">
                    ...
                    <thead>
                        <tr>
                             <th class="col-sm-4 text-center">SN No.</th>
                             <th class="col-sm-4 text-center">Date.</th>
                             <th class="col-sm-4 text-center">Rate Slip Number</th>
                            <th class="col-sm-4 text-center">Tally Slip Number</th>
                            ...
                            <th class="col-sm-4 text-center">Purchase Date</th>
                            <th class="col-sm-4 text-center">DPC</th>
                            <th class="col-sm-4 text-center">Communitative Quantity</th>
                        </tr>
                    </thead>
                    <tbody>
                        <% int i = 1;
