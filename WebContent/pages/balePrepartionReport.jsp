    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
				...
				<%
					List<BalePreparation> viewBalePreparation = (List<BalePreparation>) request.getAttribute("newbalelist");
				...
				%>
				 <form action = "pdfBalePrep.obj"  onsubmit = "return validation()">
				       <div class="page-content fade-in-up">
				      
            <div class="row">
              <div class="col-sm-4 form-group">
              <input class="form-control"
										type="hidden" name="dpc"  value="<%=dpc %>">
								  ...
								  <div class="col-sm-4 form-group">
									<label class="required">Place of Purchase</label> <input class="form-control"
										type="text" name="placeofpurchase" id="placeofpurchase" placeholder="Place of Purchase" value="<%=placeofPurchase %>">
