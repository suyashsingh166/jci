    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">BIN Details</h1>
            </div>
				<%
					List<BalePreparationModel> bale = (List<BalePreparationModel>) request.getAttribute("baleslis");	
				%>
                    ...
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
								...
								<tbody>
									<% 
										int i= 1;
										for(BalePreparationModel baleslis : bale){
									%>
									<tr>
										<td><%=i%></td>
