        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Organisation details</h1>
                    	...
                    	<%
					List<AddOrganizationModel> organisationList = (List<AddOrganizationModel>) request.getAttribute("organisationLists");	
				%>
                ...
                <div class="ibox">
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                    			...
                    			<% 
									int i= 1;
							for(AddOrganizationModel orgList : organisationList){
								
								 if(i<=200){  
							%>
									<tr>
										<td><%=i%></td>
										<td><%=orgList.getOrganizationtypedisplayname()%></td>
										<td><%=orgList.getOrganizationtypename()%></td>
