    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Region Report List</h1>
            </div>
                 <% List<DailyReportDTO> regionList = (List<DailyReportDTO>) request.getAttribute("allRegionReport"); 
                 ...
                 String DPC=(String)request.getAttribute("dpcid");
                  %>
                                     ...
                                     <form action = "RegionReportDownload.obj">
            ...
            <div class="ibox">
                    ...
                    <tbody>
                        <% int i = 1;
                        for (DailyReportDTO list : regionList) { %>
                        <tr>
                            <td><%= i %></td>
                            <td><a href="https://example.com" style="color: green;"><%= list.getRegiond() %></a></td>
